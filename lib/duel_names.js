...
/**
 * roundNames helpers module for Duel tournaments localized to English
 *
 ...
 *
 * It is therefore possible this should be moved out of tournament and be applied
 * as a mixin rather than an integrated unit given the extra customizations needed.
 * Sensible defaults is the reason for keeping it at the moment though.
 */
...
module.exports = function (last, p, partialId) {
  var br = partialId.s
    , r = partialId.r;
