...
var ffaInvalidReason = function (np, grs, adv, opts) {
  ...
  var invFinReason = finalInvalidReason(np, opts.limit | 0, grs[grs.length-1]);
...
var elimination = function (np, grs, adv, limit) {
  var invReason = ffaInvalidReason(np, grs, adv, {limit: limit});
  if (invReason !== null) {
...
FFA.invalidReason = ffaInvalidReason;
