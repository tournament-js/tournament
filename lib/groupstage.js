...
function GroupStage(numPlayers, groupSize, matches) {
  Base.call(this, numPlayers, matches || groupStage(numPlayers, groupSize));
...
GroupStage.prototype.score = function (id, score) {
...
GroupStage.prototype.unscorable = function (id, score, allowPast) {
  var m = this.findMatch(id);
  if (!m) {
