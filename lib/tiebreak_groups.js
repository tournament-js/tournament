...
var results = function (ms, posAry, limit) {
  var numGroups = posAry.length;
  var perGroup = Math.floor(limit / numGroups);
  var rem = limit % numGroups;
  ...
  //TODO: should be able to use GroupStage results if that only had taken a posAry
  return res;
...
TieBreaker.prototype.results = function () {
  return results(this.matches, this.posAry, this.limit);
};
