...
var results = function (ms, posAry, oldRes, mapsBreak) {
  ...
  // verbatim from GroupStage ATM only
  var tieCompute = function (ary, startPos, cb) {
    ...
    for (var i = 0; i < ary.length; i += 1) {
      ...
      pts = r.pts;
      maps = r.maps;
      // NB: only change from GroupStage function is extra param to cb: i
  ...
  xarys.reduce(function (currPos, xplacers) {
    ...
    //console.log($.pluck('seed', xplacers));
    ...
    tieCompute(xplacers, currPos, function (r, pos, i) {
