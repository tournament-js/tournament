...
var duelInvalidReason = function (size, last, opts) {
  ...
  if (size > 1024) {
    return "Duel tournament must have less than 1024 players";
  }
  if (size < 4) {
    return "Duel tournament must have at least 4 players";
  }
  ...
  if (opts.limit) { // TODO: possible to do I guess..
    return "Duel limits are not yet supported - they must be the last stage";
  }
  return null;
};
