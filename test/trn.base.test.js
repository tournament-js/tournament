...
test("Duel like matches", function (t) {
  ...
  t.test("match partitioning helpers", function (t) {
  ...
  t.test("current and next round helpers", function (t) {
...
test("GroupStage likes matches", function (t) {
  ...
  t.test("player helpers", function (t) {
